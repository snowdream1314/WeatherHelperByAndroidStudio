...
public class AppUtil {
	...
	public static String getAppVersionName(Context context){
		...
		String version = WHConstant.VERSION_NAME;
		try {
	...
	public static int getAppVersionCode(Context context){
		...
		int code = WHConstant.VERSION_CODE;
		try {
			PackageManager packageManager = context.getPackageManager();
			// getPackageName()是你当前类的包名，0代表是获取版本信息
			PackageInfo packInfo = packageManager.getPackageInfo(context.getPackageName(),0);
    ...
    public static boolean hasShortcut(Context context)
    {
		...
		MySharedPreference sp = new MySharedPreference(context);
        boolean isInstallShortcut = sp.getKeyBoolean(WHConstant.SharePreference_ShortcutCreated);
...
//			FLDLog.e("has shortcut");
		...
		new MySharedPreference(context).setKeyBoolean(WHConstant.SharePreference_ShortcutCreated, true);
